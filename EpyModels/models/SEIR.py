...
class SEIR(SIR):
    ...
    def __init__(self, name, population, init_s, init_e, init_i, init_r, beta, incubation_rate, recovery_rate, mortality_rate, dist_params={}):
        '''
        ...
        -----
        '''
        super(SEIR, self).__init__(name, population, init_s, init_i, init_r, beta, recovery_rate, mortality_rate, dist_params={})
        self.states['E'] = np.round(init_e*population) 
        self.params['incubation_rate'] = incubation_rate
